    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, max_length=200, verbose_name='فعال/غیر فعال')),
                ('position', models.CharField(choices=[('product_list', 'صفحه لیست محصولات'), ('product_detail', 'صفحه جزئیات محصولات'), ('article_detail', 'صفحه مقالات'), ('article_list', 'صفحه جزئیات مقالات'), ('about_us', 'صفحه تماس با ما'), ('all_pages', '+++تمامی صفحات+++')], max_length=200, verbose_name='محل قرارگیری')),
            ],
            options={
